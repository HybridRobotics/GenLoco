...
URDF_FILENAME = "robot_descriptions/aliengo_description/xacro/aliengo.urdf"
# URDF_FILENAME = "robot_descriptions/go1_description/xacro/robot.xacro"
_BODY_B_FIELD_NUMBER = 2
_LINK_A_FIELD_NUMBER = 3


class Aliengo(base_robot.Base_robot):
